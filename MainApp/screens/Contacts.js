    ...
    async componentDidMount() {
        ...
        try {
            ...
            this.setState({customerList: getCustomer.data, spinner: false},
                function() {
                    this.arrayholder = getCustomer.data;
                  } 
...
<TouchableOpacity style={{ marginHorizontal: 2, paddingVertical: 8,  alignItems: 'center' }} onPress={() => this.props.navigation.navigate("Users")}>
