...
export default class Send extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            console.log("dataSource", dataSource.bal)
        } catch (err) {
        ...
        try {
            ...
            this.setState({PercentList: getPercent.data,spinner: false});
        } catch (err) {
            // console.log("Error fetching data-----------",err);
        }
                            ...
                            <Picker style={{flex: 0.9,paddingLeft: 150}}
...

                                {
                                    this.state.PercentList.map((v) => {
                                        return <Picker.Item label={v.percentage + " % "} value={v.percentage} />
                                    })
                                }
                            </Picker>
                    ...
                    {this.state.amount != 0 ? (
                        <View style={{flexDirection: 'row',alignItems: 'center',borderWidth: 1,margin: 15,marginTop: 2,paddingHorizontal: 15}}>
                            ...
                            <Picker style={{flex: 0.9,paddingLeft: 150}}
                                ...
                                <Picker.Item label="USD Transaction" value="RateDollar" />
                                <Picker.Item label="RMD Transaction" value="RateRmd" />
