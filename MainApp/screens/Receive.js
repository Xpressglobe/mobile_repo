...
class Receive extends Component {
    ...
    //Wallet Payment and Recieve
    onPressDebit = async () => {

        this.setState({spinner: true});
   
        // Wallet Receive
        if (this.state.amount > Constant.rawNumber(this.state.bal) && this.state.c_type == 1) {

            this.setState({spinner: false,Ashow: true,show: false,Amessage: "Insufficient Please try Again"});
            return false
        } 
        // Wallet Payment
        if (this.state.amount > Constant.rawNumber(this.state.wallet) && this.state.c_type == 2) {
            ...
            <View style={{flex: 1,backgroundColor: Theme.bgcolor}} >
                ...
                <View style={styles.headContainer}>
                    ...
                    {this.state.income == 1 ? (
                        <View>
                            {this.state.c_type == 1 ? (
                                <Text style={styles.headTxt}>  Wallet Receive     </Text>
                            ) : null}

                            {this.state.c_type == 2 ? (
                                <Text style={styles.headTxt}>  Wallet Payment    </Text>
                            ) : null}
                        </View>
                ...
                <ScrollView>
                    ...
                    {this.state.c_type == 1 ? (
                        <TouchableOpacity style={{flexDirection: 'row',alignItems: 'center',paddingLeft: 20,paddingTop: 10}}  >
                            ...
                            <View>
                                <Text style={{fontFamily: 'Poppins-Regular'}}>Customer Wallet Balance :</Text>
                    ...
                    {this.state.c_type == 2 ? (
                        <TouchableOpacity style={{flexDirection: 'row',alignItems: 'center',paddingLeft: 20,paddingTop: 10}}  >
                            <Icon style={{padding: 5}} family="Entypo" name="wallet" size={30} color="#020cab" />
                            <View>
                                <Text style={{fontFamily: 'Poppins-Regular'}}>Agent Wallet Balance :</Text>
                                <Text style={{fontSize: 20,color: '#000',fontFamily: 'Poppins-ExtraLight'}}> {this.state.getCurrency} {this.state.wallet}</Text>
                            </View>
                    ...
                    {/* INCOME DEBIT  WALLET  RECEIVE AND PAY */}
                    {this.state.income == 1 ? (
                        <View>
                            {/* {this.state.c_type == 2 ? (
                            ...
                            <TouchableOpacity style={{paddingVertical: 10,backgroundColor: '#020cab',marginTop: 30,borderRadius: 50,marginHorizontal: 30}} onPress={this.handleOpen}  >
                                <Text style={{color: '#FFF',textAlign: 'center',fontSize: 16,fontFamily: 'Poppins-Bold',}}>Debit Payment</Text>
                            </TouchableOpacity>
                        </View>
